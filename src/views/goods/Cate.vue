...
<script>
import {getCateList,getParentCateList,addCate,showEditCateDialog,eidtCate,removeCate} from 'network/goods/cate'
...
export default {
    ...
    methods: {
        ...
        async showEditCateDialog (id) {
            const res = await showEditCateDialog('categories/' + id)
        ...
        eidtCate () {
            this.$refs.editCateFormRef.validate(async valid => {
                if (!valid) return
                const res = await eidtCate('categories/' + this.editCateForm.cat_id,{cat_name: this.editCateForm.cat_name})
        ...
        async removeCate (id) {
            ...
            const res = await removeCate('categories/' + id)
